    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create Award Category <a href="{{ route('award-category.index') }}" class="btn btn-primary">View Award Category</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    @isset($award)
                                    <form action="{{ route('award-category.update', $award->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("PUT")
                                    @else
                                    <form action="{{ route('award-category.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method("POST")
                                    @endif
                                    <div class="row">
                                        ...
                                        {{-- <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ isset($award)?$award->title:old('title') }}" class="form-control" name="title" placeholder="Enter Service type Title">
                                                    <p class="text-danger">
                                                        {{ $errors->first('title') }}
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <img id="icon_output" style="height: 100px;" @if(isset($award)) src="{{ Storage::disk('uploads')->url($award->image) }} @else src="{{ Storage::disk('uploads')->url('noimage.jpg') }} @endif ">
                                                    <p class="text-danger">
                                                        {{ $errors->first('image') }}
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label class="switch pt-0">
                                                        <input type="checkbox" name="publish_status" @if(isset($award)) @if($award->publish_status==1) checked @endif @endif value="1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{isset($award)?$award->meta_title:old('meta_title') }}" class="form-control" name="meta_title" placeholder="Meta Title for SEO" value="">
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img id="current_og" style="height: 100px;"@if(isset($award)) src="{{ Storage::disk('uploads')->url($award->og_image) }}"  @else src="{{ Storage::disk('uploads')->url('noimage.jpg') }}" @endif>
                                            </div>
                                            </div>
