                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted"> {{ $booking->course_type }}</p>
                                <hr> --}}
                                <strong></i>Title</strong>

                                <p class="text-muted"> {{ $booking->course_title }}</p>
                                <hr>
                                <strong></i>Price</strong>

                                <p class="text-muted"> {{ $booking->course_price }}</p>
                            </div>
                            <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
