                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <h3 class="profile-username text-center">{{$mail->name}}</h3>

                                <p class="text-muted text-center"><a href="mailto:{{ $mail->email }}">{{ $mail->email }}</a></p>

                                    <ul class="list-group list-group-unbordered ">
                                     <li class="list-group-item">
                                        <b>Contact</b> <a class="float-right">{{ $mail->contact_no }}</a>
                                    </li>
                                    
                                    {{-- <li class="list-group-item">
                                        <b>Address</b> <a class="float-right"> {{ $mail->address }} </a>
                                    </li>  --}}
                                    <li class="list-group-item">
                        ...
                        {{-- <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted"> {{ $mail->package_type }}</p>
                                <hr>
                                <strong></i> Package Title</strong>

                                <p class="text-muted"> {{ $mail->package_title }}</p>
                                <hr>
                                <strong></i> Package Price</strong>

                                <p class="text-muted"> {{ $mail->package_price }}</p>
                            </div>
                            <!-- /.card-body -->
                        </div> --}}
                        <!-- /.card -->
