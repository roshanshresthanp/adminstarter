    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Content <a href="{{ route('content.create') }}" class="btn btn-primary">Add Content</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <div class="mt-3">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="text-sm">
                                                    Showing <strong>{{ $content->firstItem() }}</strong> to
                                                    <strong>{{ $content->lastItem() }} </strong> of <strong>
                                                        {{ $content->total() }}</strong>
                                                    entries
                                                </p>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="pagination-sm m-0 float-right">{{ $content->links() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
