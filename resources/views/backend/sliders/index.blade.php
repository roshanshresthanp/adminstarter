    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sliders <a href="{{ route('slider.create') }}" class="btn btn-primary">Add Slider</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <div class="card-body table-responsive">
                                            ...
                                            @else
                                                @foreach ($sliders as $slider)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{$slider->location}}" alt="Slider" style="height: 150px; width: 350px;">
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="mt-3">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <p class="text-sm">
                                                    Showing <strong>{{ $sliders->firstItem() }}</strong> to
                                                    <strong>{{ $sliders->lastItem() }} </strong> of <strong>
                                                        {{ $sliders->total() }}</strong>
                                                    entries
                                                </p>
                                            </div>
                                            <div class="col-md-4">
                                                <span class="pagination-sm m-0 float-right">{{ $sliders->links() }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
