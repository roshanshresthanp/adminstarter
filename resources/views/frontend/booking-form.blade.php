                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="margin_down">
                                    ...
                                    <input type="text" value="{{ $plan->plantype->title }}" name="plan_type" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="margin_down">
                                    <label>Starting from</label>
                                    <input type="text" name="plan_price" value="{{ $plan->offer_price }}" class="form-control" readonly>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="margin_down">
                                    ...
                                    <input type="text" value="{{ $plan->title }}" name="plan_title" class="form-control" readonly>
                                </div>
                            </div>
