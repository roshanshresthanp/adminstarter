...
@endsection
@section('content')
<section id="inner_page_header" style="background-image:url({{ $services->banner_image == null ? asset('frontend/images/1619957642.png') : Storage::disk('uploads')->url($services->cover_image) }})" class="text_place">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <ul>
            ...
            <div class="col-lg-8">
                <div class="page_content_area_">
                    <div class="in_page_thumbnail">
                        <img src="{{Storage::disk('uploads')->url($services->icon)}}" alt="{{$services->title}}">
                    </div>
